...
#include <stdlib.h>
#include "ns_core.h"
const float delta[129] = {
  1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f, 1.3f,
  0.3528, 0.4106, 0.4684, 0.5262, 0.5841, 0.6419, 0.6997, 0.7575, 0.8153, 0.8731, 0.9309, 0.9887,
	1.0465, 1.1044, 1.1622, 1.2200, 1.2778, 1.3356, 1.3934, 1.4512, 1.5090, 1.5669, 1.6247, 1.6825,
	1.7403, 1.7981, 1.8559, 1.9137, 1.9715, 2.0294, 2.0872, 2.1450, 2.2028,
