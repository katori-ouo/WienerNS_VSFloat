...
.. c:function::  float_32 CEVA_DSP_LIB_FLOAT_LOG2_OOB(float_32 inp)

:param float_32 arg: [i] value whose log2 is calculated.
:return: calculated log2 value
:rtype: float_32
...
// =============================================================================================
float_32 CEVA_DSP_LIB_FLOAT_LOG2_OOB(float_32 inp)
{
	float_32 rez, arg, arg_exp;
	float_32 a0, a1, a2, a3, a4, a5, a6, a7, a8;
